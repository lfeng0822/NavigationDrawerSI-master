package mmbialas.pl.workday.ui;
...
import mmbialas.pl.workday.data.Fragments;
...
import mmbialas.pl.workday.ui.navigationdrawer.NavigationDrawerView;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_one), R.drawable.drawer_menu_icon_calcute, false));
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_two), R.drawable.drawer_menu_icon_query, false));
        navigationItems.add(new NavigationDrawerItem(getString(R.string.fragment_three), R.drawable.drawer_menu_icon_outline, false));
